...
from services.booking_service import total_seats,get_available_seats
...
def create_summary(db: Session, bus_id: int, travel_date: str):
    ...
    try:
        ...
        available_seats=get_available_seats(db,bus_id,travel_date)
        booked_count=total_seats-available_seats
