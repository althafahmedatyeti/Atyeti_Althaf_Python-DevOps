...
query = df.writeStream \
    ...
    .start()
bq_query = df.writeStream \
    .format("bigquery") \
    .option("table", "iot-stream-project.iot_dataset.iot_enriched_data") \
    .option("checkpointLocation", "gs://iot-stream-output-2025/checkpoints/iot-stream-bigquery/") \
    .option("temporaryGcsBucket", "iot-stream-output-2025") \
    .outputMode("append") \
    .start()
query.awaitTermination()

bq_query.awaitTermination()
